            ...
            <form @submit.prevent="handleEditSong"
                ...
                <div class="wrapper-add-song ">
                    ...
                    <div class="form-group mt-5 row">
                        ...
                        <div class="input-song col-md-8"><input type="text" id="thumbnail" v-model="thumb"></div>
                    </div>
                    <div class="form-group mt-5 row">
                        <div class="title-song col-md-4"><label for="avatarSinger">src bài hát:</label></div>
                        <div class="input-song col-md-8"><input type="text" id="avatarSinger" v-model="srcSong"></div>
                    </div>
                    <div class="form-group mt-5 row">
